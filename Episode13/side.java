...
public class side {
    public static sandwich makeSandwich(String main_sandwich_type, String side_sandwich_type) {
        String protein = "";
        int sourdough = 1;
        int lettuce = 1;
        int tomatoes = 1;
        ...
        if (main_sandwich_type.equals("blt")) {
            ...
            protein = "chicken";
        } else if (main_sandwich_type.equals("")) { // termination condition
            return sandwich;
        }
